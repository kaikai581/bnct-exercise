...
//
//
/// \file NPrimaryGeneratorAction.cc
/// \brief Implementation of the NPrimaryGeneratorAction class
...
NPrimaryGeneratorAction::NPrimaryGeneratorAction()
...
void NPrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{

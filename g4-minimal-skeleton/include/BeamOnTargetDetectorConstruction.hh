...
#ifndef BeamOnTargetDetectorConstruction_h
#define BeamOnTargetDetectorConstruction_h 1
...
class BeamOnTargetDetectorConstruction : public G4VUserDetectorConstruction
{
public:
    BeamOnTargetDetectorConstruction();
    virtual ~BeamOnTargetDetectorConstruction();
